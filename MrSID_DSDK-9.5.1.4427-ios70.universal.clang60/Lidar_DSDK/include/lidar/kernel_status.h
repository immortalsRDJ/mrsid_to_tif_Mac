...
#define LTL_KERNEL_STATUS_MESH_HEADER_READ         40219
#define LTL_KERNEL_STATUS_MESH_HEADER_WRITE        40220

#define LTL_KERNEL_STATUS_TILE_INFO_READ           40221
#define LTL_KERNEL_STATUS_TILE_INFO_WRITE          40222
#define LTL_KERNEL_STATUS_TILE_DATA_READ           40223
#define LTL_KERNEL_STATUS_TILE_DATA_WRITE          40224

#define LTL_KERNEL_STATUS_BASE_MESH_READ           40225
#define LTL_KERNEL_STATUS_BASE_MESH_WRITE          40226
#define LTL_KERNEL_STATUS_LEVEL_MESH_READ          40227
#define LTL_KERNEL_STATUS_LEVEL_MESH_WRITE         40228
#define LTL_KERNEL_STATUS_MESH_COPY                40229
