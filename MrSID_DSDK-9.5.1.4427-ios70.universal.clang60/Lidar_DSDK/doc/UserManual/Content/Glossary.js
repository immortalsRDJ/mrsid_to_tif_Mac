CMCXmlParser._FilePathToXmlStringMap.Add(
	...
	'                    <a href=\"javascript:void(0);\" class=\"GlossaryPageTerm\" id=\"MCDropDownHotSpot_477041989_0\" onclick=\"FMCDropDown( this ); FMCScrollToVisible( window, this.parentNode.parentNode ); return false;\">My Term</a>' +
	'                    <a name=\"477041989_anchor1\">' +
	'                    </a>' +
	'                </div>' +
	'                <div class=\"GlossaryPageDefinition\" id=\"MCDropDownBody_477041989_0\" style=\"display: none;\">My definition</div>' +
	'            </div>' +
	'        </div>' +
	'        <p>&#160;</p>' +
