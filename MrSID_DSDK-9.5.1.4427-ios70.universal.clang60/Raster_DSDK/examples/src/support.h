...
#define INPUT_PATH(filename) ("RasterExample.app/data/" filename)
#define OUTPUT_PATH(filename) ("Documents/" filename)
#elif defined(__ANDROID__)
#define INPUT_PATH(filename) ("/sdcard/RasterDSDK/data/" filename)
#define OUTPUT_PATH(filename) ("/sdcard/RasterDSDK/" filename)
#else
