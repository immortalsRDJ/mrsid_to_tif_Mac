...
2. Copy the Raster_DSDK/examples/data directory to /sdcard/RasterDSDK/data on the
...
3. If you use the Eclipse IDE, complete the following additional steps:
  * Import the existing Android code into the workspace specifying Raster_DSDK/examples/src
    as the Root Directory.
   * Right-click the RasterExamples project, and click Android > Add Native Support...
